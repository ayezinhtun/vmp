...
export const AccountSettingsView: React.FC<AccountSettingsViewProps> = ({ role, setView }) => {
  ...
  const meByRole: Record<string, any> = {
    'Admin': state.team.find((t: any) => t.role === 'Admin'),
    'Sales': state.team.find((t: any) => t.role === 'Sales'),
    'Engineer': state.team.find((t: any) => t.role === 'Engineer'),
    'Finance': state.team.find((t: any) => t.role === 'Finance'),
  }
