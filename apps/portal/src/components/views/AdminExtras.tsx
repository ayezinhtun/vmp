...
export const BackupCenterView: React.FC = () => {
  ...
  const allSnapshots = state.vms.filter((v: any) => v.backup && v.backup !== 'None').flatMap((v: any) =>
  ...
  return (
    <div className="content">
      ...
      <div className="grid-4 mb-4">
        <div className="metric"><div className="label">Backups today</div><div className="value tnum">{state.vms.filter((v: any) => v.backup && v.backup !== 'None').length}</div><div className="trend">All successful</div></div>
        ...
        {tab === 'schedules' && (
          <div className="card-body flush">
            <table className="tbl">
              ...
              <tbody>
                {state.vms.filter((v: any) => v.backup && v.backup !== 'None').map((v: any) => (
                  <tr key={v.id}>
